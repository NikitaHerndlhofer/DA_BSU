...
# Set random seed. 
set.seed(42)
setwd("/cloud/project/6_clustering")
...
df = data.frame(k=seq(1,7), ratio_ss)

plot(ratio_ss, type = "b", xlab = "k")

g1 <- ggplot(data = df, aes(x = k, y = ratio_ss)) + 
  geom_line() + 
  geom_point()
g1
...
print(dunn_km) #0.1604403
print(dunn_single) #0.2438734
